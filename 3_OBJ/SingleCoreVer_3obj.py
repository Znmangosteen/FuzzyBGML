import algorithm_3obj, util, random, time
import fuzzyRule_3obj, os, sys
...
def run(data_set, size, gen_num, times):
    ...
    for i in range(times):
        ...
        print("start")
        pareto_set, population = algorithm_3obj.NSGAII(population=population, p=p, gen_num=gen_num, constant=constant,
...
if __name__ == '__main__':
    ...
    pareto_set, population = run(data_set, size, gen_num, times)
